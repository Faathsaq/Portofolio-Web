        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              A graduate of Informatics Engineering from Diponegoro University with a strong passion for UI/UX Design. I focus on creating intuitive, aesthetic, and user-centered digital interfaces while consistently striving to deliver the best design solutions in every project I work on.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              {/* ✅ Updated direct JPG download link */}
              <a
                href="https://drive.google.com/uc?export=download&id=15NYdaM1TUOLgfXpC9gV3o-6IajbJ3eTR"
                download="Faiz_Athaillah_Tsaqif_CV.jpg"
